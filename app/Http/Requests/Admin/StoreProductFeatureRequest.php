...
class StoreProductFeatureRequest extends FormRequest
{
    ...
    {
        return $this->user()->can('create', ProductFeature::class);
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'key' => [
                ...
                'max:255', 
                'regex:/^[a-z0-9-_]+$/',
                'unique:product_features,key,NULL,id,product_id,' . $this->product_id,
            ],
            'description' => ['nullable', 'string'],
            'type' => ['required', 'string', 'in:boolean,numeric,text,list'],
